...
{
    class ScrollingBackgroundBackwardsTwo
    {
        ...
        public ScrollingBackgroundBackwardsTwo()
        {
            scrollingSpeed = 2;
        }
        ...
        public void LoadContent(ContentManager Content)
        {
            ...
            scrollingOne = Content.Load<Texture2D>("backgrounds/scrolling/scrolling1backwardstwo");
            scrollingTwo = Content.Load<Texture2D>("backgrounds/scrolling/scrolling2backwardstwo");

            scrollingOneRect = new Rectangle(0, 70, 810, 600);
            scrollingTwoRect = new Rectangle(-800, 70, 810, 600);
