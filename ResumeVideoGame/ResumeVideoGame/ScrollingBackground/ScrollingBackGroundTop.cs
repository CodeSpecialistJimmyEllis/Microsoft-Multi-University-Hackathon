...
namespace ResumeVideoGame
{
    class ScrollingBackgroundTop
    {
        ...
        public void LoadContent(ContentManager Content)
        {
            ...
            scrollingOneRect = new Rectangle(800, 0, 800, 100);
            scrollingTwoRect = new Rectangle(0, 0, 800, 100);
        ...
        public void Update(GameTime gameTime)
        {
            ...
            /*
            #region scrolling background equation
            ...
            #region scrollingbackwards equation
