...
namespace JESUSISLORDplatformer
{
    class ScrollingBackground
    {
        ...
        public void LoadContent(ContentManager Content)
        {
            ...
            scrollingOne = Content.Load<Texture2D>("backgrounds/scrolling/scrolling1");
            scrollingTwo = Content.Load<Texture2D>("backgrounds/scrolling/scrolling2");

            scrollingOneRect = new Rectangle(0, 0, 800, 600);
            scrollingTwoRect = new Rectangle(-800, 0, 800, 600);
