...
{
    class ScrollingBackgroundBackwards
    {
        ...
        public ScrollingBackgroundBackwards()
        {
            scrollingSpeed = 3;
        }
        ...
        public void LoadContent(ContentManager Content)
        {
            ...
            scrollingOne = Content.Load<Texture2D>("backgrounds/scrolling/scrolling1backwards");
            scrollingTwo = Content.Load<Texture2D>("backgrounds/scrolling/scrolling2backwards");

            scrollingOneRect = new Rectangle(0, 0, 810, 600);
            scrollingTwoRect = new Rectangle(-800, 0, 810, 600);
